...
console.log('Need to order more food:', shouldOrderMore);
...
var vegetables = ['spinach', 'peas', 'broccoli', 'carrots', 'bell peppers'];

// Write the code to access the 3rd element of the Array, using bracket
// notation.

console.log('3rd vegetable element:', vegetables[2]);

// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.

var fruits = ['watermelon', 'blue berries', 'grapes', 'apples', 'oranges', 'strawberries', 'pears'];

// Write the code to access the 5th element of the array, using bracket notation.

console.log('5th fruit element:', fruits[4]);
...
var groceryStore = {
    ...
    hasMeatMarket: true,
    freshBakedGoods: ['cookies', 'pies', 'cakes', 'french bread', 'gluten-free bread']
}
...
console.log('Grocery Store Object:', groceryStore);